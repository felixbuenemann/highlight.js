    ...
    lang.contains = [
        ...
        .mode({
            ...
            mode.keywords = .grouped([
                "keyword": "addion cfunc cmd cmpopt comfunc const defcfunc deffunc define else endif enum epack func global if ifdef ifndef include modcfunc modfunc modinit modterm module pack packopt regcmd runtime undef usecom uselib" as Any,
            ])
...
/// Register hsp language
public extension HighlightJS {
    func registerHsp() {
        registerLanguage("hsp", definition: hspLanguage)
    }
}
